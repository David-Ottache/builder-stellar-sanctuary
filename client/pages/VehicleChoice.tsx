    ...
    <Layout hideTopBar hideBottomNav>
      <div className="mx-4 mt-4 rounded-3xl bg-white p-6 shadow-soft">
        ...
        <div className="mt-6 space-y-3">
          <button className={`w-full rounded-2xl border p-4 text-left ${choice==="car"?"border-primary bg-primary/5":""}`} onClick={()=>setChoice("car")}>
          ...
          <button className={`w-full rounded-2xl border p-4 text-left ${choice==="bike"?"border-primary bg-primary/5":""}`} onClick={()=>setChoice("bike")}>
            <div className="flex items-center justify-between">

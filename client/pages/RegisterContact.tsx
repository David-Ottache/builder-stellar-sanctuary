    ...
    <Layout hideTopBar hideBottomNav>
      <div className="mx-4 mt-4 rounded-3xl bg-white p-6 shadow-soft">
        ...
        <div className="mt-6 space-y-3">
          <input value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="Enter Email Address" className="w-full rounded-xl border bg-neutral-100 px-4 py-3 outline-none focus:bg-white" />
          <div className="flex gap-2">
            <select className="w-28 rounded-xl border bg-neutral-100 px-3 py-3 outline-none focus:bg-white" defaultValue={onboarding.countryCode || "+234"} onChange={(e)=>setOnboarding({ countryCode: e.target.value })}>

        ...
        <div className="absolute bottom-[5.5rem] left-0 right-0 z-20">
          <div className="mx-4 rounded-t-3xl border-t bg-white/95 p-4 pb-4 shadow-2xl backdrop-blur supports-[backdrop-filter]:bg-white/75">
            ...
            <div className="text-2xl font-bold">
              {estimatedFare !== null ? `₦${estimatedFare.toLocaleString()}` : 'Enter destination to see estimate'}
            </div>
            <Button className="mt-3 w-full rounded-full" onClick={handleStart} disabled={!destinationCoords}>Start Trip</Button>
          </div>
        </div>
      )}
    </Layout>

...
export const verifyUserOtp: RequestHandler = async (req, res) => {
  try {
    ...
    const q = await db.collection('users').where('phone', '==', phone).where('otpCode', '==', code).get();
    ...
    console.error('verifyUserOtp error', e);
